...
public class VentaDAO {
    ...
    private static final String SQL_SELECT_PAGOS= " ";
    
//    private static final String SQL_SELECT_ID_PAGOS = "SELECT id_pagos FROM Pagos ORDER BY id_pagos DESC LIMIT 1";
    private static final String SQL_SELECT_P_ASOCIADOS= "SELECT * FROM Productos RIGHT JOIN DetalleVentas ON Productos.id_productos = DetalleVentas.id_producto WHERE DetalleVentas.id_venta =";
